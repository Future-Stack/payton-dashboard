                ...
                <div className="grid grid-cols-2 gap-2">
                  {(
                    ...
                    <button
                      ...
                      className={`py-2 px-3 rounded-lg text-sm font-medium transition-colors text-center capitalize ${localFilter.status === opt
                ...
                <div className="grid grid-cols-3 gap-2">
                  {(["All", "FREE", "PRO"] as UserSubscription[]).map((opt) => (
                    <button
                      ...
                      className={`py-2 px-3 rounded-lg text-sm font-medium transition-colors text-center ${localFilter.userSubscription === opt
                        ? "bg-[#117A88] text-white"
                        : "bg-[#2a3143] text-slate-300 hover:bg-[#343c53] hover:text-white"
                        }`}
                    >
                ...
                <div className="bg-[#242933] border border-[#2A303C] rounded-2xl p-4 shrink-0">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-between items-center p-3 rounded-xl bg-[#2C323E]">
                      ...
                      <span
                        className={`text-sm font-bold uppercase ${selectedReport.status?.toLowerCase() === "approved"
                          ? "text-[#10B981]"
